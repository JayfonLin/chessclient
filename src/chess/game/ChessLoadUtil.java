...
public class ChessLoadUtil {
	 ...
	 *兵向前一格
	 */
	public static int SquareForward(int piecePosition, int side){
	 ...
	 *走法是否符合仕(士)的步长
	 */
	public static boolean BodyguardSpan(int pieceSrc, int pieceDst){
	 ...
	 *是否是同一方棋子
	 */
	public static boolean SameSide(int typeA, int typeB){
		return IsRed(typeA)&&IsRed(typeB) || IsBlack(typeA)&&IsBlack(typeB);
	}
	...
	public static boolean IsRed(int type){
